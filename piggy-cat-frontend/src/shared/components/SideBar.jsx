...
export default function SideBar() {
  return (
    <aside className="flex flex-col  p-3 h-screen">
      ...
      <div className="flex flex-col gap-4 justify-start items-start p-4 text-(--font-color-primary) ">
        <div className="flex justify items-start  pb-4 ">
      ...
      <div className="flex flex-col justify-center items-start  pb-6 mt-auto gap-4">

        <div className="w-full">
        <hr className="border-t-[rgba(255,255,255,0.15)]" />
      </div>
       
        <NavLink to="/configuracion" className="flex items-center gap-4 pb-4 text-(--font-color-primary) ">
          <Settings className="w-6" /> Configuracion
        </NavLink>
        <NavLink to="/ahorro" className="flex items-center gap-4 pb-4 text-(--font-color-primary) ">
