...
export default function Dashboard() {
  return (
    <div className="top-bar flex flex-col p-6 h-screen">
      {/* Barra superior con titulo y calendario */}
      <div className="top-bar flex justify-between items-center p-2 mb-6">
        <h2 className='text-4xl font-bold text-white/80'>Dashboard</h2>
        <div className="calendar flex items-center gap-4">
          <div className="btn flex justify-center items-center border border-white/20 rounded-lg px-4 py-2 gap-2">
           ...
           <div className="date border border-white/20 rounded-lg px-4 py-2">
      ...
      <div className="stats-grid flex justify-between gap-6 p-4">
        ...
        <div className="flex flex-col justify-center items-center bg-(--bg-card-color) rounded-sm p-12 gap-4 border border-white/20 w-lg">
          <h2 className='text-2xl font-bold border-b border-white/20 pb-2'>
            Capital neto
          </h2>
          <span className='text-4xl font-bold text-(--font-color-secondary)'>$0.00</span>
        </div>

        <div className=" card-inversion flex flex-col justify-center items-center bg-(--bg-card-color) rounded-sm p-12 gap-4 border border-white/20 w-lg">
          <h2 className='text-2xl font-bold border-b border-white/20 pb-2'>
            Ingresos del mes
          </h2>
          <span className='text-4xl font-bold text-(--font-color-secondary)'>$0.00</span>
        ...
        <div className=" card-ganancia flex flex-col justify-center items-center bg-(--bg-card-color) rounded-sm p-12 gap-4 border border-white/20 w-lg">
          <h2 className='text-2xl font-bold border-b border-white/20 pb-2'>
            Egresos del mes
          </h2>
          <span className='text-4xl font-bold text-(--font-color-secondary)'>$0.00</span>
